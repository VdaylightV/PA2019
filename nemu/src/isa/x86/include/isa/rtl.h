  ...
  // dest <- is_overflow(src1 - src2)
    ...
    if(*src2 != 0x80000000){ 
		...
		switch(width) {
			case 1: {printf("1-1\n"); if ((((*src1)>>7) && 0x1 == ((~(*src2)+1)>>7) && 0x1) && ((((*src1)>>7) && 0x1) != (((*res)>>7) && 0x1))) *dest = 0; else *dest = 1; printf("src1:%x\n",((*src1)>>7)&0x1); printf("src2:%x\n",((*src2)>>7)&0x1); printf("res:%x\n",((*res)>>7)&0x1); break;}
			case 2: {printf("1-2\n"); if ((((*src1)>>15) && 0x1 == ((~(*src2)+1)>>15) && 0x1) && ((((*src1)>>15) && 0x1) != (((*res)>>15) && 0x1))) *dest = 0; else *dest = 1; printf("src1:%x\n",((*src1)>>15)&0x1); printf("src2:%x\n",((*src2)>>15)&0x1); printf("res:%x\n",((*res)>>15)&0x1); break;}
			case 4: {printf("1-4"); if ((((*src1)>>31) && 0x1 == ((~(*src2)+1)>>31) && 0x1) && ((((*src1)>>31) && 0x1) != (((*res)>>31) && 0x1))) *dest = 0; else *dest = 1; printf("src1:%x\n",((*src1)>>31)&0x1); printf("src2:%x\n",((*src2)>>31)&0x1); printf("res:%x\n",((*res)>>31)&0x1); break;}
			default: assert(0);
		}
	}
