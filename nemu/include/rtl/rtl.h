...
extern rtlreg_t s0, s1, s2, s3, t0, t1, t2, ir;
...
static inline void rtl_sext(rtlreg_t* dest, const rtlreg_t* src1, int width) {
  ...
  switch(width) {
	  case 1: {if((((*src1) >> 7) & 1) == 1) *dest = ((*src1) | 0xffffff00); else *dest = ((*src1) | 0x00000000); break;}
	  case 2: {if((((*src1) >> 15) & 1) == 1) *dest = ((*src1) | 0xffff0000); else *dest = ((*src1) | 0x00000000); break;}
...
static inline void rtl_mux(rtlreg_t* dest, const rtlreg_t* cond, const rtlreg_t* src1, const rtlreg_t* src2) {
  ...
  //TODO();
  switch(*cond) {
	  case 1:{*dest = *src1; break;}
	  case 0:{*dest = *src2; break;}
	  default: assert(0);
  }
}
